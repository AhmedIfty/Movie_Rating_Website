...
<?php include("admin_modal_series.php"); ?>
<style>
    .body{
...
<body class="body">
<div class="container">
    <h2 class="name">Series</h2><br>

    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <button class="btn btn-primary" type="button" 
    data-bs-toggle="modal" data-bs-target="#exampleModal">Add Series</button>
    </div>
            ...
            <?php
                ...
                if (!$result){
                    ...
                    <tr>
                        ...
                        <td><a href="admin_update_series.php?id=<?php echo $row['content_id']; ?>" class="btn btn-success">Update</td>
                        <td><a href="admin_delete_series.php?id=<?php echo $row['content_id']; ?>" class="btn btn-danger">Delete</td>
                    </tr>
