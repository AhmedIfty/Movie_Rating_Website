<!-- Modal form for movies -->
<form action="admin_insert_movie.php" method="post">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="type">Type of content [type 'movie']</label>
                ...
                <!-- <div class="form-group">
                    <label for="season">Num of Season [for 'anime and series only]</label>
