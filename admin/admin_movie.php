...
<?php include("admin_modal_movie.php"); ?>
<style>
    .body{
...
data-bs-toggle="modal" data-bs-target="#exampleModal">Add Movie</button>
</div>
        ...
        <?php
            ...
            if (!$result){
                ...
                <tr>
                    ...
                    <td><a href="admin_update_movie.php?id=<?php echo $row['content_id']; ?>" class="btn btn-success">Update</td>
                    <td><a href="admin_delete_movie.php?id=<?php echo $row['content_id']; ?>" class="btn btn-danger">Delete</td>
                    
                    <!-- <td>
                    <div class="container">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-danger" type="button" 
                     data-bs-toggle="modal" data-bs-target="#EexampleModal">Delete</button>
                    </div>
                    </td> -->
